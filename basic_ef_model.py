...
returns =   np.array([0.100, 0.080, 0.040, 0.045, 0.050, 0.070])

vols =      np.array([0.150, 0.120, 0.070, 0.080, 0.090, 0.100])

corr_matrix = np.array([[1.00, 0.76, 0.35, 0.50, 0.24, 0.30],
                        [0.76, 1.00, 0.04, 0.30, 0.36, 0.25],
                        [0.35, 0.04, 1.00, 0.87, 0.62, -0.05],
                        [0.50, 0.30, 0.87, 1.00, 0.52, -0.02],
                        [0.24, 0.36, 0.62, 0.52, 1.00, 0.20],
                        [0.30, 0.25, -0.05, -0.02, 0.20, 1.00]])
